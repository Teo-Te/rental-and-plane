...
export default function Footer() {
    return (
        ...
        <footer className="footer p-10 bg-base-200 text-base-content">
            <nav>
                <h6 className="footer-title">Sherbimet</h6> 
                <Link href="/" className="link link-hover">1</Link>
                <Link href="/" className="link link-hover">2</Link>
                <Link href="/" className="link link-hover">3</Link>
                <Link href="/" className="link link-hover">4</Link>
            </nav> 
            <nav>
                <h6 className="footer-title">Kompania jone</h6> 
                <Link href="/" className="link link-hover">1</Link>
                <Link href="/" className="link link-hover">2</Link>
                <Link href="/" className="link link-hover">3</Link>
                <Link href="/" className="link link-hover">4</Link>
            ...
            <nav>
                <h6 className="footer-title z-0">Kontakt</h6> 
                <Link href="/" className="link link-hover">1</Link>
                <Link href="/" className="link link-hover">2</Link>
                <Link href="/" className="link link-hover">3</Link>
            </nav>
            ...
            <aside className="items-center grid-flow-col">
                ...
                <p>Emri i Kompanise<br/>Slogani ktu</p>
            </aside> 
