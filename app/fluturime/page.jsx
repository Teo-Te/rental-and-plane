        ...
        <div className="flex flex-col join justify-center bg-base-200 pt-2 pb-2">
            ...
            <div className="flex join w-full p-2 justify-center">
                <div>
                    <div className="flex flex-col">
                        <input className="input input-bordered join-item w-1/2" placeholder="Nisja"/>
                    </div>
                </div>
                <div>
                    <div>
                        <input className="input input-bordered join-item w-1/2" placeholder="Destinacioni"/>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-row w-full justify-center items-center sm:px-5 pt-4">
                <div className="sm:pr-12">
                    <div>
                        <div className="flex flex-col">
                            <input className="input input-bordered join-item" placeholder="Emri"/>
                        </div>
                    </div>
                    <div>
                        <div>
                            <input className="input input-bordered join-item" placeholder="Mbiemri"/>
                        </div>
                    </div>
                    <div>
                        <div>
                            <input className="input input-bordered join-item" placeholder="Nr. i celularit"/>
                        </div>
                    </div>
                </div>
