    ...
    return (
        <>
            <div className="flex flex-col items-center">
                <div className="carousel carousel-center max-w-md p-4 space-x-4" ref={carouselRef}>
            ...
            <h2 className="flex justify-center text-2xl font-bold text-white">Mercedes Benz E Class</h2>
